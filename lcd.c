 ...
 *
 * [DESCRIPTION]:	<A source file for LCD driver>
 --------------------------------------------------------------------------------------*/
...
void LCD_init(void)
{
	...
	GPIO_setPinDirection(LCD_RS_PORT, LCD_RS_PIN, PIN_OUTPUT);
	GPIO_setPinDirection(LCD_RW_PORT, LCD_RW_PIN, PIN_OUTPUT);
	GPIO_setPinDirection(LCD_E_PORT, LCD_E_PIN, PIN_OUTPUT);
